...
export const cellBack =
  'block py-2 px-4 border-b border-gray-200 hover:bg-gray-50 cursor-pointer';

export const cell =
  'py-2 px-4 border-b border-gray-300 last-of-type:border-none hover:bg-gray-50';
