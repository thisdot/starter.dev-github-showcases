...
@Component({
  selector: 'app-file-explorer-nav-skeleton',
  templateUrl: './file-explorer-nav-skeleton.component.html',
  styleUrls: ['../file-explorer-nav.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FileExplorerNavSkeletonComponent implements OnInit {
  @Input() owner = '';
  @Input() name = '';
  @Input() branch = 'master';
