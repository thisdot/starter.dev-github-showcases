...
export const buttonContainer = 'flex flex-col w-full bg-gray-100 mb-3 items-center text-grey-600 rounded-md border-solid border-slate-500 border hover:bg-gray-200';
