export const ClosedIssueIcon = (props) => {
  return (
    <svg viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true" fill="currentColor" class={props.class ?? ''}>
...
export default ClosedIssueIcon
