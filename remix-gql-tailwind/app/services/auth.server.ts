...
if (!process.env.APP_GITHUB_CLIENT_ID) {
  throw new Error('APP_GITHUB_CLIENT_ID is required');
}

if (!process.env.APP_GITHUB_CLIENT_SECRET) {
  throw new Error('APP_GITHUB_CLIENT_SECRET is required');
}
