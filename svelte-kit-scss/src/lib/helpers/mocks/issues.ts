...
export const MOCK_SEARCH_ISSUE: GithubSearchIssue = {
  ...
  html_url: 'http://sample_url.com',
};

export const MOCK_SEARCH_ISSUE_PULL: GithubSearchIssue = {
  id: 35802,
  number: 132,
  title: 'Line Number Indexes Beyond 20 Not Displayed',
  user: {
  ...
  locked: true,
  author_association: GithubIssueAuthorAssociation.Collaborator,
  html_url: 'http://sample_url.com/issue',
  pull_request: {
    url: 'http://sample_url.com/pull_request/url',
    html_url: 'http://sample_url.com/pull_request/html_url',
    merged_at: null,
  },
};
