/**
 * Copied from https://github.com/ozh/github-colors repository with DWTFYWT public license
 */

export function getColourForLanguage(language: string): string {
	return colours[language]?.color || '#000';
}

const colours: Record<string, { color: string | null; url: string }> = {
	'1C Enterprise': {
		color: '#814CCC',
