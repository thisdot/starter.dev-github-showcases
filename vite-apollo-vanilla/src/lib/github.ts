...
export type NavBarUserFragment = { __typename?: 'User', login: string, avatarUrl: any };

export type StandardLayoutQueryVariables = Exact<{ [key: string]: never; }>;


export type StandardLayoutQuery = { __typename?: 'Query', viewer: { __typename?: 'User', login: string, avatarUrl: any } };

export const NavBarUserFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"NavBarUser"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}}]} as unknown as DocumentNode;
export const StandardLayoutDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"StandardLayout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"viewer"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"NavBarUser"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"NavBarUser"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}}]}}]} as unknown as DocumentNode;

/**
 * __useStandardLayoutQuery__
 *
 * To run a query within a React component, call `useStandardLayoutQuery` and pass it any options that fit your needs.
 * When your component renders, `useStandardLayoutQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStandardLayoutQuery({
 *   variables: {
 *   },
 * });
 */
export function useStandardLayoutQuery(baseOptions?: Apollo.QueryHookOptions<StandardLayoutQuery, StandardLayoutQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<StandardLayoutQuery, StandardLayoutQueryVariables>(StandardLayoutDocument, options);
      }
export function useStandardLayoutLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<StandardLayoutQuery, StandardLayoutQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<StandardLayoutQuery, StandardLayoutQueryVariables>(StandardLayoutDocument, options);
        }
export type StandardLayoutQueryHookResult = ReturnType<typeof useStandardLayoutQuery>;
export type StandardLayoutLazyQueryHookResult = ReturnType<typeof useStandardLayoutLazyQuery>;
export type StandardLayoutQueryResult = Apollo.QueryResult<StandardLayoutQuery, StandardLayoutQueryVariables>;